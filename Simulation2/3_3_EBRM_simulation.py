...
BUFFER_SIZE=100; particle_N = 5; LR=1e-2; BATCH_SIZE=BUFFER_SIZE; Iterations=1500; REPORTING_FREQ = 500; display_size=300;  
...
for seedno in seedvec:
    ...
    np.save('ebrm_results/' + game + '_seed'+str(seedno), (Estimate_returns_original, energy_inaccuracy, cumulative_seconds))
