...
### Here, there is no random seed, so trained model should be different.
...
gamma=0.99; max_step = 200000 # (gamma, T) to train the optimal pollicy => This is roughly good level.
# gamma=0.999; max_step = 300000
...
if game == "cartpole":
    ...
    assert "game should be Cartpole."
...
replay_buffer=deque(maxlen=buffer_size) # The size of our replay_buffer D is not going to exceed buffer_size.
