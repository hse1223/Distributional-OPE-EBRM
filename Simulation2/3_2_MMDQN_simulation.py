...
BATCH_SIZE=1; display_size=300 # not recommended to change this.
args = parse_args()
...
directory_name = "Results/" + NN_size+str(n_particle)+"_sample"+str(BUFFER_SIZE) + "/mmdqn"
    ...
    def __init__(self, input_dim):
        ...
        if NN_size=="small":
            ...
            self.network = nn.Sequential(
                ...
                nn.Linear(64, 64),
                nn.ReLU(),
                nn.Linear(64, action_num*n_particle) 
            )
